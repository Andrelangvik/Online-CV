...
## Oppgave 2
```{r}
print(lm(deaths_per_100k ~ fully, data = my_df)) 
```

**Her kan man se at avskjæringen er 31.15 og at kofferisenten for dødsraten er - 36.66. Dette forteller oss at den antatte dødsraten vil synke fremover som en konsekvens av at flere bli vaksinert. **
